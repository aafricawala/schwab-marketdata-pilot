...
========================================================================================
Changelog v16.21:
  - Fixed NameError: Instantiated default clean extraction telemetry in extract_strict_underlying_data.
  - Restored 4-tuple return for extract_in_memory_option_chains (vol_30d, spot, contracts, telemetry).
  - Resolved get_market_hours keyword argument incompatibility.
  - PAY-57: EPS sanitization for foreign ADRs with positive net profit margins.
  - PAY-59: Purged residual 'volatility_30d_surface' from surface_parameters.
  - PAY-61: Explicit fundamental extraction of 'marketCap' for divergence gating.
  - PAY-46/51/52/53: 5-state margin table and denominator validity checks.
========================================================================================
"""
...
def extract_strict_underlying_data(
    ...
    """Extracts quotes, fundamentals, and locate reference data from Schwab endpoints."""
    ...
    # PAY-57: EPS sanitization for foreign ADRs and negative margin scenarios
    ...
    # PAY-61: Extract reported market capitalization directly from broker fundamentals
